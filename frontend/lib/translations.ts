export const translations = {
  en: {
    ...
    zoom: "zoom",
    levelExpert: "Expert",
    levelIntermediate: "Strong",
    monitorTitle: "SYSTEM MONITOR",
    monitorSubtitle: "Real-time observability into backend infrastructure.",
    redisStatus: "Redis Engine",
    queueStatus: "Workload Queue",
    systemUptime: "Uptime",
    memoryUsage: "Memory",
  ...
  vi: {
    ...
    levelIntermediate: "Vững vàng",
    monitorTitle: "GIÁM SÁT HỆ THỐNG",
    monitorSubtitle: "Theo dõi thời gian thực hạ tầng backend.",
    redisStatus: "Redis Engine",
    queueStatus: "Hàng đợi xử lý",
    systemUptime: "Thời gian chạy",
    memoryUsage: "Bộ nhớ",
    activeJobs: "Đang xử lý",
    waitingJobs: "Đang chờ",
    reset: "Đặt lại",
    loading: "Đang tải...",
    reScan: "QUÉT LẠI",
